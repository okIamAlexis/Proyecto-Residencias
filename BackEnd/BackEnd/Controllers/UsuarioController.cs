    ...
    public class UsuarioController : ControllerBase
    {
        ...
        public async Task<IActionResult> Post([FromBody]Usuario usuario)
        {
            try
            {
                ...
                return Ok(new { message = "El usuario: " + usuario.NombreUsuario + " fue registrado con exito! Usuario Registrado!" });
            }
        ...
        //para acceder a esta ruta es necesario acceder a esta ruta necesitamos autenticarnos con el Jwt 
        //---> localhost:xxx/api/Usuairio/CambiarPassword <---
