...
{
    public class RespuestaCuestionarioService: IRespuestaCuestiorioService
    {
        ...
        public async Task<List<RespuestaCuestionario>> Respuestas(int idCuestionario, int idUsuario)
        {
            return await _respuestaCuestionarioRepository.Respuestas(idCuestionario, idUsuario);
        }
